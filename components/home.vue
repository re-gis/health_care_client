                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title">
                                ...
                                <img src="/img/section-img.png" alt="#">
                                <p>Welcome to the future of medicine,<br> where personalized healthcare meets cutting-edge technology. In this exciting new era, your health takes the spotlight as we harness the power of innovation to tailor your medical journey uniquely to you.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="testimonial-wrap">
                                ...
                                <p>
                                    ...
                                    From home we could contact a more or less immediate pediatrist that prescribed medication to our son.Thank you My Doctor IN-HOME.
                            ...
                            <div class="testimonial-wrap">
                                ...
                                <p>
                                    <i class="icofont icofont-quote-left quote-icon-left"></i>
                                    Fantastic...From the time I started to use My Doctor IN-HOME I got to speak to a surgeon for a second opinion.In an hour I was able to speak to a Top Doctor and got all my doubts solved.
                                    <i class="icofont icofont-quote-right quote-icon-right"></i>
                                </p>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-wrap">
                                ...
                                <p>
                                    <i class="icofont icofont-quote-left quote-icon-left"></i>
                                    We got the help that traditional care can't match. Thank you so much for this great service!
                                    <i class="icofont icofont-quote-right quote-icon-right"></i>
                                </p>
                                </div>
                            </div>
                            ...
                            <div class="testimonial-wrap">
                                ...
                                <p>
                                    <i class="icofont icofont-quote-left quote-icon-left"></i>
                                    With My Doctor IN-HOME you don't have to go to the health center anymore or wait never ending lists!
                                    <i class="icofont icofont-quote-right quote-icon-right"></i>
                                </p>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="choose-left">
                                ...
                                <p><i class="icofont icofont-ssl-security font-color-blue"></i>Secure & Private: <br>Rest assured, your privacy is our priority. Our telehealth services are encrypted and secure, ensuring your personal health information stays confidential.<br>
                                   <i class="icofont icofont-user font-color-blue"></i> Personalized Care: <br>We believe in healthcare that's tailored just for you. Our team of experienced healthcare professionals will provide you with individualized treatment plans and expert advice, all from a screen near you.<br>
                                   <i class="icofont icofont-file-document font-color-blue"></i> Easy Appointments: <br>Scheduling an appointment has never been easier. With just a few clicks, you can book a virtual visit at a time that suits your busy schedule.<br>
                                   <i class="icofont icofont-plus font-color-blue"></i> Continuity of Care: <br>Whether you need a follow-up consultation, specialist opinion, or ongoing care, we've got you covered. Our telehealth platform offers seamless continuity in your healthcare journey.<br>
                                   <i class="icofont icofont-file-wave font-color-blue"></i> Accessible to All: <br>Our telehealth services are designed to be inclusive, ensuring that quality healthcare reaches everyone, regardless of location, mobility, or time constraints.<br>
                                   <i class="icofont icofont-hand-power font-color-blue"></i> Take Control of Your Health: <br>You are at the center of your healthcare journey. With personalized telehealth, you have the power to actively manage your health and well-being.</p>
            ...
            <section class="services section faq section-bg" id="faq">
                <div class="container">
                    ...
                    <div class="faq-list">
                        <ul>
                            <li data-aos="fade-up">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is telehealth, and how does it work?<i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                                <p>
                                    Telehealth is a virtual healthcare service that allows you to have remote consultations with healthcare providers using video, phone, or chat. You can connect with your healthcare provider from the comfort of your home, saving time and effort.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="100">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Is telehealth secure and private? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Yes, telehealth platforms prioritize security and privacy. Your confidential medical information is protected, and your video consultations are encrypted to maintain privacy.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="200">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Do I need special equipment for telehealth appointments? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    You typically need a device with a camera and microphone, such as a smartphone, tablet, or computer, and a reliable internet connection. Your healthcare provider will guide you through the process.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="300">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">What types of healthcare services can I access through telehealth? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Telehealth is suitable for a wide range of medical services, including routine check-ups, specialist consultations, mental health support, and follow-up appointments. Some services, such as emergency care, may require in-person visits.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="400">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How do I schedule a telehealth appointment? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    You can schedule a telehealth appointment by contacting your healthcare provider's office or using the telehealth platform's scheduling system. Choose a convenient time and receive a confirmation.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="500">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-6" class="collapsed">Is insurance accepted for telehealth appointments? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-6" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Many insurance providers cover telehealth services. Check with your insurance company to confirm coverage and any associated costs. We also offer insurance guidance to assist you.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="600">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-7" class="collapsed">What if I have technical difficulties during a telehealth appointment? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-7" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    If you encounter technical issues, contact the telehealth platform's support team for assistance. They can help troubleshoot problems to ensure a successful consultation.
                                </p>
                            </div>
                            </li>

                            <li data-aos="fade-up" data-aos-delay="700">
                            <i class="icofont icofont-question-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-8" class="collapsed">How do I access my medical records after a telehealth appointment? <i class="icofont icofont-simple-down icon-show"></i><i class="icofont icofont-simple-up icon-close"></i></a>
                            <div id="faq-list-8" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Your healthcare provider will store your medical records securely, and you can typically access them through the telehealth platform. Ask your provider for instructions on how to retrieve your records.
                                </p>
                            </div>
                            </li>
                    ...
                    <div class="row ">
                        <div class="col-lg-6  col-12">
                            ...
                            <div class="subscribe-text ">
                                ...
                                <p class="">Sign up for our newsletter and stay in the loop with the latest in telehealth, healthcare tips, and exclusive offers, ensuring you never miss a beat in your journey to well-being</p>
                            </div>
                            <!-- End Newsletter Form -->
                        </div>
                        <div class="col-lg-6  col-12">
