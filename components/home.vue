<template>
  <!-- <section class="section section-search d-none">
  ...
  <section class="slider">
    <div class="hero-slider">
      <div
        class="single-slider"
        style="background-image: url('/img/slider/slider.png')"
      ></div>
      <div
        class="single-slider"
        style="background-image: url('/img/slider/slider2.png')"
      ></div>
      <div
        class="single-slider"
        style="background-image: url('/img/slider/slider3.png')"
      ></div>
    </div>
  </section>
  <!-- <BannerBody /> -->
  ...
  <!-- Start service -->
  <section
    class="services w-[100%] flex flex-col justify-center items-center section"
  >
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-title text-center">
            ...
            <p>
              “Embark on a healthcare journey like never before with our
              cutting-edge telehealth services. Designed to cover the unmet
              needs of real patients, our platform ensures integrated care,
              offering comprehensive coverage to the entire population of
              Bahrain. With a specialized focus on pathology-grouped patients,
              we provide tailored solutions to prioritize your well-being.
              Welcome to the future of healthcare, where quality care is
              accessible and personalized. Join us today for a healthier
              tomorrow”
            </p>
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div class="col-span-1 md:col-span-2 lg:col-span-1">
          ...
          <div class="single-service">
            ...
            <div class="ml-4">
              <h4 class="font-[500] text-[15px]">
                <a href="service-details.html"
                  >Designed to cover unmet needs of real patients:</a
                >
              </h4>
        ...
        <div class="col-span-1 md:col-span-1 lg:col-span-1">
          ...
          <div class="single-service">
            ...
            <div class="ml-4">
              <h4 class="font-[500] text-[15px]">
                <a href="service-details.html"
                  >Designed to support integrated chain of care:</a
                >
              </h4>
              <p class="text-sm">
                “we help boost self-referral of patients to specialists”
              </p>
            </div>
          </div>
          <!-- End Single Service -->
        ...
        <div class="col-span-1 md:col-span-1 lg:col-span-1">
          ...
          <div class="single-service">
            ...
            <div class="ml-4">
              <h4 class="font-[500] text-[15px]">
                <a href="service-details.html"
                  >Designed to cover the full population of Bahrain:</a
                >
              </h4>
              <p class="text-sm">
                “we provide a tested service of care scalable and secure”
              </p>
            </div>
          </div>
          <!-- End Single Service -->
        ...
        <div class="col-span-1 md:col-span-2 lg:col-span-1">
          ...
          <div class="single-service">
            ...
            <div class="ml-4">
              <h4 class="font-[500] text-[15px]">
                <a href="service-details.html"
                  >Designed to avoid waiting lists and uncertainty:</a
                >
              </h4>
              <p class="text-sm">
                “we link patients, health providers, caregivers, caretakers and
                family”
              </p>
            </div>
          </div>
        ...
        <div class="col-span-1 md:col-span-1 lg:col-span-1">
          ...
          <div class="single-service">
            ...
            <div class="ml-4">
              <h4 class="font-[500] text-[15px]">
                <a href="service-details.html">Designed to attend in-time:</a>
              </h4>
              <p class="text-sm">
                “we permit in-time and coordinated intervention”
              </p>
            </div>
          </div>
          <!-- End Single Service -->
        ...
        <div class="col-span-1 md:col-span-1 lg:col-span-1">
          ...
          <div class="single-service">
            ...
            <div class="ml-4">
              <h4 class="font-[500] text-[15px]">
                <a href="service-details.html"
                  >Designed with pathology grouped patients:</a
                >
              </h4>
        ...
        <div class="relative w-full pr-[15px] pl-[15px]">
          <div class="content w-[1250px] text-center pl-[80px]">
            ...
            <p>
              ...
              emergency calls and requests. Simply dial the toll-free number 999
              from any phone to call for ambulance services.
            </p>
            <p>
      ...
      <div class="flex flex-wrap mx-[-15px]">
        <div class="relative w-[100%] py-[15px]">
          <div class="section-title w-[1250px] block px-[250px] text-center">
            ...
            <img src="/img/section-img.png" alt="#" />
            <p>
              Welcome to the future of medicine,<br />
              where personalized healthcare meets cutting-edge technology. In
              this exciting new era, your health takes the spotlight as we
              harness the power of innovation to tailor your medical journey
              uniquely to you.
            </p>
          </div>
        </div>
            ...
            <div class="news-body">
              <div class="news-content pl-[80px]">
                ...
                <h2 class="text-center">
                  <a href="#"
                    >Book an online in-person appointment with a Doctor</a
                  >
                </h2>
                <p class="text text-center block-center">
                  LDermatologists. Dentists. Psychologists. Psychiatrists.
                  Pohthalmologists. Orthopaedic surgenons. Urologists.
                  Obstetricians-gynecologists. Otolaryngologists. Vascular
                  surgeons. Allergists.
                </p>
              </div>
            </div>
          ...
          <div class="single-news">
            ...
            <div class="news-body">
              <div class="news-content pl-[80px]">
                ...
                <h2 class="text-center">
                  <a href="#"
                    >Asking a doctor a Medical query has never been so easy!</a
                  >
                </h2>
          ...
          <div class="single-news">
            ...
            <div class="news-body">
              <div class="news-content pl-[80px]">
                ...
                <h2 class="text-center">
                  <a href="#"
                    >Instant Access to Thousands of Trusted Doctors!</a
                  >
                </h2>
                <p class="text text-center block-center">
                  Encrypted to Secure your Privacy and security and your family
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="testimonial-wrap">
              <div class="testimonial-item">
                ...
                <h4>Ceo &amp; Founder</h4>
                <p>
                  <i class="icofont icofont-quote-left quote-icon-left"></i>
                  From home we could contact a more or less immediate pediatrist
                  that prescribed medication to our son.Thank you My Doctor
                  IN-HOME.
                  <i class="icofont icofont-quote-right quote-icon-right"></i>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="testimonial-wrap">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="icofont icofont-quote-left quote-icon-left"></i>
                  Fantastic...From the time I started to use My Doctor IN-HOME I
                  got to speak to a surgeon for a second opinion.In an hour I
                  was able to speak to a Top Doctor and got all my doubts
                  solved.
                  <i class="icofont icofont-quote-right quote-icon-right"></i>
                </p>
              </div>
          ...
          <div class="swiper-slide">
            <div class="testimonial-wrap">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="icofont icofont-quote-left quote-icon-left"></i>
                  We got the help that traditional care can't match. Thank you
                  so much for this great service!
                  <i class="icofont icofont-quote-right quote-icon-right"></i>
                </p>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="testimonial-wrap">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="icofont icofont-quote-left quote-icon-left"></i>
                  With My Doctor IN-HOME you don't have to go to the health
                  center anymore or wait never ending lists!
                  <i class="icofont icofont-quote-right quote-icon-right"></i>
                </p>
              </div>
            </div>
      ...
      <div class="flex w-[100%] flex-wrap justify-center">
        <div class="relative w-1/2 pr-[15px] pl-[15px]">
          ...
          <div class="choose-left">
            ...
            <p>
              <i class="icofont icofont-ssl-security font-color-blue"></i>Secure
              & Private: <br />Rest assured, your privacy is our priority. Our
              telehealth services are encrypted and secure, ensuring your
              personal health information stays confidential.<br />
              <i class="icofont icofont-user font-color-blue"></i> Personalized
              Care: <br />We believe in healthcare that's tailored just for you.
              Our team of experienced healthcare professionals will provide you
              with individualized treatment plans and expert advice, all from a
              screen near you.<br />
              <i class="icofont icofont-file-document font-color-blue"></i> Easy
              Appointments: <br />Scheduling an appointment has never been
              easier. With just a few clicks, you can book a virtual visit at a
              time that suits your busy schedule.<br />
              <i class="icofont icofont-plus font-color-blue"></i> Continuity of
              Care: <br />Whether you need a follow-up consultation, specialist
              opinion, or ongoing care, we've got you covered. Our telehealth
              platform offers seamless continuity in your healthcare journey.<br />
              <i class="icofont icofont-file-wave font-color-blue"></i>
              Accessible to All: <br />Our telehealth services are designed to
              be inclusive, ensuring that quality healthcare reaches everyone,
              regardless of location, mobility, or time constraints.<br />
              <i class="icofont icofont-hand-power font-color-blue"></i> Take
              Control of Your Health: <br />You are at the center of your
              healthcare journey. With personalized telehealth, you have the
              power to actively manage your health and well-being.
            </p>
          </div>
          <!-- End Choose Left -->
        </div>
  ...
  <section class="services section faq section-bg" id="faq">
    <div class="w-[100%]">
      ...
      <div class="faq-list">
        <ul>
          <li data-aos="fade-up">
            <i class="icofont icofont-question-circle icon-help"></i>
            <a
              data-bs-toggle="collapse"
              class="collapse"
              data-bs-target="#faq-list-1"
              >What is telehealth, and how does it work?<i
                class="icofont icofont-simple-down icon-show"
              ></i
              ><i class="icofont icofont-simple-up icon-close"></i
            ></a>
            <div
              id="faq-list-1"
              class="collapse show"
            ...
            >
              <p>
                Telehealth is a virtual healthcare service that allows you to
                have remote consultations with healthcare providers using video,
                phone, or chat. You can connect with your healthcare provider
          ...
          <li data-aos="fade-up" data-aos-delay="100">
            ...
            <a
              ...
              <i class="icofont icofont-simple-down icon-show"></i
              ><i class="icofont icofont-simple-up icon-close"></i
            ></a>
            <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
              <p>
                Yes, telehealth platforms prioritize security and privacy. Your
                confidential medical information is protected, and your video
                consultations are encrypted to maintain privacy.
              </p>
            </div>
          </li>
          ...
          <li data-aos="fade-up" data-aos-delay="200">
            ...
            <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
              <p>
                You typically need a device with a camera and microphone, such
                as a smartphone, tablet, or computer, and a reliable internet
                connection. Your healthcare provider will guide you through the
                process.
              </p>
            </div>
          </li>
          ...
          <li data-aos="fade-up" data-aos-delay="300">
            ...
            <a
              ...
              class="collapsed"
              >What types of healthcare services can I access through
              telehealth? <i class="icofont icofont-simple-down icon-show"></i
              ><i class="icofont icofont-simple-up icon-close"></i
            ></a>
            <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
              <p>
                Telehealth is suitable for a wide range of medical services,
                including routine check-ups, specialist consultations, mental
                health support, and follow-up appointments. Some services, such
                as emergency care, may require in-person visits.
              </p>
            </div>
          </li>
          ...
          <li data-aos="fade-up" data-aos-delay="400">
            ...
            <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
              <p>
                You can schedule a telehealth appointment by contacting your
                healthcare provider's office or using the telehealth platform's
                scheduling system. Choose a convenient time and receive a
                confirmation.
              </p>
            </div>
          </li>
          ...
          <li data-aos="fade-up" data-aos-delay="500">
            ...
            <a
              ...
              class="collapsed"
              >Is insurance accepted for telehealth appointments?
              <i class="icofont icofont-simple-down icon-show"></i
              ><i class="icofont icofont-simple-up icon-close"></i
            ></a>
            <div id="faq-list-6" class="collapse" data-bs-parent=".faq-list">
              <p>
                Many insurance providers cover telehealth services. Check with
                your insurance company to confirm coverage and any associated
                costs. We also offer insurance guidance to assist you.
              </p>
            </div>
          </li>
          ...
          <li data-aos="fade-up" data-aos-delay="600">
            ...
            <a
              ...
              class="collapsed"
              >What if I have technical difficulties during a telehealth
              appointment? <i class="icofont icofont-simple-down icon-show"></i
              ><i class="icofont icofont-simple-up icon-close"></i
            ></a>
            <div id="faq-list-7" class="collapse" data-bs-parent=".faq-list">
              <p>
                If you encounter technical issues, contact the telehealth
                platform's support team for assistance. They can help
                troubleshoot problems to ensure a successful consultation.
              </p>
            </div>
          </li>
          ...
          <li data-aos="fade-up" data-aos-delay="700">
            ...
            <a
              ...
              class="collapsed"
              >How do I access my medical records after a telehealth
              appointment? <i class="icofont icofont-simple-down icon-show"></i
              ><i class="icofont icofont-simple-up icon-close"></i
            ></a>
            <div id="faq-list-8" class="collapse" data-bs-parent=".faq-list">
              <p>
                Your healthcare provider will store your medical records
                securely, and you can typically access them through the
                telehealth platform. Ask your provider for instructions on how
      ...
      <div class="flex items-center flex-wrap mx-[-15px] justify-center">
        <div class="relative mx-[15px] w-1/2">
          ...
          <div class="subscribe-text">
            ...
            <p class="">
              Sign up for our newsletter and stay in the loop with the latest in
              telehealth, healthcare tips, and exclusive offers, ensuring you
              never miss a beat in your journey to well-being
            </p>
          </div>
          <!-- End Newsletter Form -->
        </div>
...
<script>
import BannerBody from "~/components/landing/BannerBody.vue";
import ScheduleBody from "~/components/landing/ScheduleBody.vue";
import WhyChooseBody from "~/components/landing/WhyChooseBody.vue";
                      ...
                      if (
                        (l
                          ...
                          : (p &&
                            ...
                            u &&
                              (n.attr("sizes", u), n.removeAttr("data-sizes")),
                            h.length &&
              ...
              updateSlide: (e, r, n, l) => {
                ...
                if ("row" === p && o > 1) {
                  const s = Math.floor(e / (o * c)),
                    a = e - c * o * s,
                    i =
                      0 === s ? o : Math.min(Math.ceil((n - s * c * o) / c), o);
                  (m = Math.floor(a / i)),
                    (h = a - m * i + s * o),
                    (u = h + (m * t) / c),
                    r.css({
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < e.length; s += 1) {
                ...
                if ((m && f.shadow) || !m) {
                  ...
                  if (
                    (0 === e.length && f.shadow && (e = ie(r, a)), e.length)
                  ) {
    ...
    !(function (t, e) {
      ...
      class st extends H {
        ...
        _handleSwipe() {
          ...
          (this._deltaX = 0),
            e &&
              g(e > 0 ? this._config.rightCallback : this._config.leftCallback);
        }
        _initEvents() {
          this._supportPointerEvents
      ...
      N.on(document, Wn, '[data-bs-toggle="offcanvas"]', function (t) {
        const e = z.getElementFromSelector(this);
        if (
          (["A", "AREA"].includes(this.tagName) && t.preventDefault(), l(this))
        )
          return;
        N.one(e, Fn, () => {
          a(this) && this.focus();
      ...
      class Ks extends W {
        ...
        _keydown(t) {
          ...
          i &&
            (i.focus({ preventScroll: !0 }), Ks.getOrCreateInstance(i).show());
        }
        _getChildren() {
